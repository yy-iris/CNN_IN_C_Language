...
int main(int argc, char *argv[]){
	...
	//Prepare Input
	float ***img;
	img = load_RGB("input", 1, 24,129);

	Tensor *t;
	t = make_tensor(1, 24, 129, img);
	//show_matrix(t, 1, 24, 129);
	...
	//show_matrix(t, 32, 8, 65);
	t = MaxPool(t, 1, 3, 1, 2, SAME, 1);
	//show_matrix(t, 32, 8, 33);
	t = Conv(t, _conv2d_2, ReLU_activation, 1);
	//show_matrix(t, 48, 8, 11);
	t = MaxPool(t, 1, 3, 1, 2, SAME, 1);
	//show_matrix(t, 48, 8, 6);
	t = Conv(t, _conv2d_3, ReLU_activation, 1);
	//show_matrix(t, 64, 8, 2);
	t = MaxPool(t, 1, 3, 1, 2, SAME, 1);
	//show_matrix(t, 64, 8, 1);
	t = FlattenD(t, 1);
	//show_matrix(t, 512, 1, 1);
	t = Dense(t, _dense_1, ReLU_activation, 1);
	//show_matrix(t, 64, 1, 1);
